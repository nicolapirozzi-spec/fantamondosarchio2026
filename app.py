...
def calcola_tassa_da_file(squadra):
    ...
    # Se l'utente ha già salvato le sue scelte, usa quelle
    if squadra in scelte:
        return scelte[squadra]["tassa"]
    # Altrimenti di default calcola sul 100% dei giocatori nell'Excel
     ...
     if menu == "Home":
        ...
        if giocatori.empty:
            ...
            for idx, row in giocatori.iterrows():
                # Se l'utente ha già salvato in precedenza, ripristina lo stato esatto della spunta
